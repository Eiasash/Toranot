...
export const DRUG_DOSING: Record<string, DrugDosingEntry> = {
  ...
  trimethoprim_sulfamethoxazole: {
    label: "TMP-SMX (Bactrim)",
    normal: "160/800mg (1 DS tab) PO q12h",
    crcl_10_50: "CrCl 15–30: 1 DS tab PO q24h; CrCl 15–30 IV: 5–7.5mg/kg TMP q24h",
    crcl_lt10: "AVOID (accumulation of sulfamethoxazole + risk of hyperkalemia)",
    hd: "AVOID or use only if dialysis removes drug — consult pharmacy",
    notes: "Causes hyperkalemia (blocks ENaC like K-sparing diuretic). Particularly dangerous with ACEi/ARB. Check K+ on day 3–5.",
  },
  ertapenem: {
    label: "Ertapenem",
    normal: "1g IV q24h",
    crcl_10_50: "CrCl 10–30: 500mg IV q24h",
    crcl_lt10: "500mg IV q24h",
    hd: "500mg IV q24h (supplemental dose after HD if given within 6h of HD)",
    notes: "Daily dosing advantage for outpatient/OPAT. Does NOT cover Pseudomonas.",
  },
  linezolid: {
    label: "Linezolid",
    normal: "600mg PO/IV q12h",
    crcl_10_50: "No renal adjustment",
    crcl_lt10: "No renal adjustment (metabolites accumulate — monitor for toxicity)",
    hd: "No renal adjustment; supplemental 200mg after HD recommended by some",
    notes: "Serotonin syndrome risk with SSRIs/SNRIs/tramadol. Myelosuppression with courses >14d — CBC weekly. MAO inhibitor activity.",
  },
  doxycycline: {
    label: "Doxycycline",
    normal: "100mg PO/IV q12h",
    crcl_10_50: "No renal adjustment",
    crcl_lt10: "No renal adjustment (hepatic elimination)",
    hd: "No renal adjustment",
    notes: "One of few antibiotics requiring NO renal dose adjustment — useful in severe CKD/dialysis when alternatives contraindicated.",
  },
};

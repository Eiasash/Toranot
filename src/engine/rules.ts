...
const COMFORT_SUPPRESSED_GROUPS = new Set([
  ...
  // iv_opioid + iv_midazolam: Q2H vital-sign monitoring suppressed for comfort/palliative patients.
  // Waking a dying patient for Q2H RR/SpO2 checks contradicts comfort goals.
  // Qualitative comfort checks generated by comfort_sedation_symptom rule (comfortCareOnly:true).
  "iv_opioid",
  "iv_midazolam",
  "iv_propofol",
  "iv_magnesium",
...
const RULES: Rule[] = [
  ...
  // ═══ NPO ═══
  {
    ...
    tasks: [
      {
        text: "לוודא צום - ללא אוכל ושתייה",
        urgency: "stat",
        category: "other",
      },
  ...
  // ═══ PRE-OP ═══
  {
    ...
    tasks: [
      {
        text: "בדיקות דם טרום ניתוח (CBC, CMP, PT/INR, סוג ושתלב)",
        urgency: "stat",
        category: "labs",
      },
      ...
      {
        text: "ABx מניעתי לפי פרוטוקול DAG",
        urgency: "routine",
        category: "meds",
      },
    ],
  ...
  {
    trigger:
      /עירוי\s*(?:דם|טסיות|פלזמה)|(?:מנת|מנות)\s*דם|PRBCs?|FFP|packed\s*cells|platelets?\s*transfusion|blood\s*transfusion|טרנספוזיה/i,
    source: "עירוי דם",
    group: "transfusion",
    triggerField: "all",
    tasks: [
      ...
      {
        text: "Vitals q15min ×4 during transfusion, then q1h",
        urgency: "routine",
        category: "procedure",
      },
      {
        text: "Watch for transfusion reaction: fever, rash, dyspnea, flank pain",
        urgency: "routine",
        category: "other",
      },
      {
        text: "Post-transfusion CBC 1h after completion",
        urgency: "routine",
        category: "labs",
      },
    ],
  ...
  // ═══ BLADDER SCAN ═══
  {
    ...
    tasks: [
      {
        text: "BS (Bladder Scan) — קטטר חד פעמי אם >400ml",
        urgency: "routine",
        category: "procedure",
      },
    ],
  ...
  // ═══ PNEUMONIA — DAG: Ceftriaxone ± Azithromycin ═══
  {
    ...
    tasks: [
      ...
      {
        text: "אנטיגן שתן: Legionella + Pneumococcus",
        urgency: "routine",
        category: "labs",
      },
      {
        text: "ABx — DAG: Ceftriaxone 2g IV + Azithromycin 500mg (CAP); Pip-Tazo (HAP)",
        urgency: "stat",
        category: "meds",
      },
      {
        text: "חישוב CURB-65 (ראה עזר קליני)",
        urgency: "routine",
        category: "other",
      },
  ...
  // ═══ UTI — DAG: Ciprofloxacin PO / Ceftriaxone IV ═══
  {
    ...
    tasks: [
      {
        text: "תרבית שתן + בדיקת שתן כללית (לפני ABx!)",
        urgency: "stat",
        category: "labs",
      },
      {
        text: "תרביות דם x2 (אם חום/ספסיס)",
        urgency: "stat",
        category: "labs",
      },
      {
        text: "ABx — DAG: Ciprofloxacin 500 PO (לא מסובך) / Ceftriaxone 2g IV",
        urgency: "stat",
        category: "meds",
      },
      {
        text: "שקול הוצאת/החלפת קטטר אם קיים",
        urgency: "routine",
        category: "procedure",
      },
    ],
  ...
  // ═══ SEPSIS — DAG: Pip-Tazo ± Amikacin ═══
  {
    ...
    tasks: [
      {
        text: "🔴 תרביות דם x2 משני אתרים (לפני ABx!)",
        urgency: "stat",
        category: "labs",
      },
      { text: "🔴 לקטט סרום (Lactate)", urgency: "stat", category: "labs" },
      {
        text: "🔴 ABx רחב תוך שעה — DAG: Pip-Tazo 4.5g IV q6h",
        urgency: "stat",
        category: "meds",
      },
      {
        text: "🔴 נוזלים IV: NaCl 0.9% — 30ml/kg bolus",
        urgency: "stat",
        category: "meds",
      },
      {
        text: "ניטור שתן — יעד >0.5ml/kg/h",
        urgency: "routine",
        category: "other",
      },
      { text: "לקטט חוזר לאחר 4-6 שעות", urgency: "routine", category: "labs" },
      {
        text: "אם לקטט >4 / הלם → שקול ICU + vasopressors",
        urgency: "routine",
        category: "consult",
      },
    ],
  ...
  // ═══ CELLULITIS — DAG: Cefazolin IV / Cephalexin PO ═══
  {
    ...
    tasks: [
      {
        text: "סימון גבולות בעט (+ תאריך+שעה)",
        urgency: "routine",
        category: "other",
      },
      { text: "תיעוד צילום", urgency: "routine", category: "other" },
      {
        text: "ABx — DAG: Cefazolin 2g IV q8h / Cephalexin 500 PO q6h",
        urgency: "stat",
        category: "meds",
      },
      {
        text: "אם מוגלה → Clindamycin (MRSA) + ניקוז",
        urgency: "routine",
        category: "meds",
      },
    ],
  ...
  // ═══ C. DIFFICILE — DAG: PO Vancomycin 125mg q6h ═══
  {
    ...
    tasks: [
      {
        text: "שליחת צואה ל-C.diff PCR/Toxin",
        urgency: "stat",
        category: "labs",
      },
      { text: "בידוד מגע!", urgency: "stat", category: "other" },
      {
        text: "הפסקת ABx מיותרים (Fluoroquinolones, Clindamycin)",
        urgency: "stat",
        category: "meds",
      },
      {
        text: "טיפול — DAG: Vancomycin 125mg PO q6h x10d",
        urgency: "routine",
        category: "meds",
      },
    ],
  ...
  // ═══ FEVER WORKUP ═══
  {
    ...
    tasks: [
      ...
      {
        text: "מעבדה: CBC, CRP, Procalcitonin",
        urgency: "routine",
        category: "labs",
      },
      {
        text: "מיפוי מקור: קו מרכזי? קטטר? פצע? צלוליטיס?",
        urgency: "routine",
        category: "other",
      },
    ],
  ...
  // ═══ AKI ═══
  {
    ...
    tasks: [
      {
        text: "US כליות (שלילת חסימה)",
        urgency: "routine",
        category: "imaging",
      },
      {
        text: "הפסקת נפרוטוקסיים: NSAIDs, ACEi, ARB, Aminoglycosides",
        urgency: "stat",
        category: "meds",
      },
      { text: "הערכת מצב נפחי + I/O", urgency: "stat", category: "other" },
      {
        text: "מעבדה: Cr, BUN, K+, Na+, גזים, FENa",
        urgency: "stat",
        category: "labs",
      },
      {
        text: "אם Pre-renal → NaCl bolus; אין שיפור → נפרולוג",
        urgency: "routine",
        category: "consult",
      },
      {
        text: "התאמת מינון תרופות ל-CrCl (ראה עזר קליני)",
        urgency: "routine",
        category: "meds",
      },
    ],
  ...
  {
    trigger:
      /היפרקלמיה|hyperkalemia|K\+?\s*>\s*5\.?[5-9]|K\+?\s*>\s*[67]|אשלגן\s*גבוה/i,
    source: "היפרקלמיה",
    group: "hyperK",
    tasks: [
      {
        text: "🔴 א.ק.ג STAT (peaked T, wide QRS)",
        urgency: "stat",
        category: "labs",
      },
      {
        text: "🔴 Calcium Gluconate 10% 10ml IV (אם שינויי ECG)",
        urgency: "stat",
        category: "meds",
      },
      {
        text: "Insulin 10U IV + Dextrose 50% 50ml IV",
        urgency: "stat",
        category: "meds",
      },
      { text: "Kayexalate 30g PO / PR", urgency: "routine", category: "meds" },
      {
        text: "K+ חוזר + ECG חוזר לאחר שעה",
        urgency: "routine",
        category: "labs",
      },
      {
        text: "אם K>6.5 / שינויי ECG → שקול דיאליזה",
        urgency: "stat",
        category: "consult",
      },
    ],
  ...
  // ═══ HYPOKALEMIA ═══
  {
    ...
    tasks: [
      {
        text: "בדוק Mg2+ (חיוני להעלאת K+)",
        urgency: "stat",
        category: "labs",
      },
      {
        text: "K+ PO 40-80mEq/d (אם K>3.0)",
        urgency: "routine",
        category: "meds",
      },
      {
        text: "K+ IV: KCl 10mEq/h (אם K<3.0 — מוניטור)",
        urgency: "stat",
        category: "meds",
      },
      {
        text: "ECG (U wave, ST depression)",
        urgency: "routine",
        category: "labs",
      },
  ...
  {
    trigger:
      /כאב.*חזה|chest\s*pain|ACS|STEMI|NSTEMI|אוטם|MI\b|טרופונין.*גבוה|תסמונת כלילית/i,
    source: "כאב חזה / ACS",
    group: "acs",
    ...
    tasks: [
      ...
      {
        text: "NTG SL 0.4mg q5min x3 (אם SBP>90)",
        urgency: "stat",
        category: "meds",
      },
  ...
  {
    trigger:
      /אי.?ספיקת לב|CHF|heart\s*failure|בצקת ריאות|pulmonary\s*edema|HFrEF|HFpEF/i,
    source: "אי-ספיקת לב",
    group: "chf",
    triggerField: "tasks",
    tasks: [
  ...
  // ═══ DVT / PE ═══
  {
    ...
    tasks: [
      ...
      {
        text: "אם PE מסיבי → שקול thrombolysis + ICU",
        urgency: "stat",
        category: "consult",
      },
    ],
  ...
  {
    trigger:
      /דליריום|delirium|בלבול חריף|agitat|ערפול.*הכרה|acute\s*confusion|חוסר\s*שקט|אי\s*שקט|restless|sundowning/i,
    source: "דליריום",
    group: "delirium",
    triggerField: "all",
    tasks: [
      ...
      {
        text: "⚡ בירור דחוף: זיהום? תרופות? מטבולי? היפוקסיה? עצירות? אצירת שתן?",
        urgency: "stat",
        category: "other",
      },
      {
        text: "מעבדה: CBC, BMP, Ca2+, Mg2+, PO4, גלוקוז, U/A+תרבית, גזים",
        urgency: "stat",
        category: "labs",
      },
      {
        text: "Bladder Scan — שלילת אצירה (>300ml → קטטר)",
        urgency: "stat",
        category: "procedure",
      },
      {
        text: "סקור תרופות: STOP anticholinergics, benzos, opioids, steroids",
        urgency: "stat",
        category: "meds",
      },
      // ── NON-PHARM (always first-line) ──
      {
        text: "אמצעים לא-תרופתיים: תאורה, שעון, משקפיים, שמיעה, שתייה, משפחה, הסר קטטרים מיותרים",
        urgency: "routine",
        category: "other",
      },
      // ── PHARMACOTHERAPY — single reference, pick one based on scenario ──
      {
        text: "💊 אגיטציה — בחר לפי מצב: Quetiapine 12.5-25mg PO (קו 1, בטוח בפרקינסון) | Haloperidol 0.5mg IM (❌ לא בDLB, בדוק QTc) | Olanzapine 2.5mg (אם QTc ארוך) | רפרקטורי: Lorazepam 1mg IV (מוצא אחרון!)",
        urgency: "routine",
        category: "meds",
      },
    ],
  ...
  // ── Haloperidol (Haldol) ──
  {
    ...
    tasks: [
      {
        text: "א.ק.ג לפני ואחרי מתן — QTc >500ms → STOP",
        urgency: "stat",
        category: "procedure",
      },
      {
        text: "ניטור EPS: נוקשות, טרמור, אקתיזיה, דיסטוניה",
        urgency: "routine",
        category: "other",
      },
      {
        text: "❌ אם פרקינסון/DLB → החלף ל-Quetiapine 12.5-25mg",
        urgency: "stat",
        category: "meds",
      },
      {
        text: "מינון קשישים: 0.5mg IM (PO אם משתף פעולה). ❌ לא >3mg/24h",
        urgency: "routine",
        category: "meds",
      },
    ],
  ...
  // ── Quetiapine (Seroquel) ──
  {
    ...
    tasks: [
      {
        text: "BP שכיבה + עמידה (אורתוסטטי!) — לפני ואחרי מתן",
        urgency: "routine",
        category: "procedure",
      },
      {
        text: "מינון התחלתי: 12.5-25mg PO HS. Max 50mg/d בקשישים",
        urgency: "routine",
        category: "meds",
      },
      {
        text: "ניטור סדציה מוגזמת — סיכון נפילות",
        urgency: "routine",
        category: "other",
      },
      {
        text: "BS בבוקר (hyperglycemia risk)",
        urgency: "routine",
        category: "labs",
      },
    ],
  ...
  // ── Olanzapine (Zyprexa) ──
  {
    ...
    tasks: [
      {
        text: "❌ לא עם IM benzodiazepines! (respiratory depression)",
        urgency: "stat",
        category: "meds",
      },
      {
        text: "BP — סיכון להיפוטנציה אורתוסטטית",
        urgency: "routine",
        category: "procedure",
      },
      {
        text: "מינון קשישים: 2.5-5mg PO/IM. Max 10mg/d",
        urgency: "routine",
        category: "meds",
      },
      {
        text: "BS — hyperglycemia + metabolic effects",
        urgency: "routine",
        category: "labs",
      },
    ],
  ...
  // ── Risperidone (Risperdal) ──
  {
    ...
    tasks: [
      {
        text: "BP שכיבה + עמידה — orthostatic hypotension",
        urgency: "routine",
        category: "procedure",
      },
      {
        text: "מינון קשישים: 0.25-0.5mg PO BID. Max 2mg/d",
        urgency: "routine",
        category: "meds",
      },
      {
        text: "ניטור EPS (סיכון גבוה יותר מ-quetiapine)",
        urgency: "routine",
        category: "other",
      },
      {
        text: "⚠ FDA Black Box: ↑ mortality בדמנציה",
        urgency: "routine",
        category: "other",
      },
    ],
  ...
  // ── Dexmedetomidine (Precedex) ──
  {
    ...
    tasks: [
      {
        text: "HR + BP q15min — bradycardia + hypotension common",
        urgency: "stat",
        category: "procedure",
      },
      {
        text: "Sedation score (RASS) q1-2h — target 0 to -2",
        urgency: "routine",
        category: "procedure",
      },
      {
        text: "Loading dose: 1mcg/kg over 10min → 0.2-0.7 mcg/kg/h",
        urgency: "routine",
        category: "meds",
      },
      {
        text: "ICU/ניטור setting only — continuous telemetry required",
        urgency: "stat",
        category: "other",
      },
    ],
  ...
  // ── Trazodone (for delirium insomnia/sundowning) ──
  {
    ...
    tasks: [
      {
        text: "BP — orthostatic hypotension risk, especially nocturnal",
        urgency: "routine",
        category: "procedure",
      },
      {
        text: "מינון: 25-50mg PO HS. ❌ לא >100mg בקשישים",
        urgency: "routine",
        category: "meds",
      },
      {
        text: "ניטור סדציה יתרה בבוקר — סיכון נפילות",
        urgency: "routine",
        category: "other",
      },
    ],
  ...
  {
    trigger:
      /מלטונין\s*(?:\d|delirium|דליריום|prevention)|melatonin\s*(?:\d|delirium|prevention)/i,
    source: "מלטונין (מניעת דליריום)",
    group: "delirium_melatonin",
    triggerField: "all",
    tasks: [
      {
        text: "Melatonin 3-5mg PO HS — מניעת דליריום (HELP protocol)",
        urgency: "routine",
        category: "meds",
      },
      {
        text: "ודא: אין סדציה מוגזמת בבוקר",
        urgency: "routine",
        category: "other",
      },
    ],
  ...
  {
    trigger:
      /דימום.*GI|GI\s*bleed|מלנה|melena|המטמזיס|hematemesis|הקאת דם|דם.*צואה/i,
    source: "דימום GI",
    group: "gibleed",
    triggerField: "tasks", // History of GI bleed vs active bleeding
    tasks: [
      {
        text: "🔴 סוג ושתלב + הזמנת 2 מנות דם",
        urgency: "stat",
        category: "labs",
      },
      {
        text: "🔴 2 גישות ורידיות רחבות (18G+)",
        urgency: "stat",
        category: "procedure",
      },
      { text: "נוזלים IV bolus", urgency: "stat", category: "meds" },
      {
        text: "PPI IV: Omeprazole 80mg bolus → 8mg/h drip",
        urgency: "stat",
        category: "meds",
      },
      {
        text: "מעבדה: CBC, CMP, PT/INR, Fibrinogen, לקטט",
        urgency: "stat",
        category: "labs",
      },
      { text: "התייעצות גסטרו דחופה", urgency: "stat", category: "consult" },
      {
        text: "הפסקת NSAIDs + אנטיקואגולנטים",
        urgency: "stat",
        category: "meds",
      },
  ...
  // ═══ WARFARIN / INR ═══
  {
    ...
    tasks: [
      ...
      {
        text: "INR 3-5 (ללא דימום) → דלג מנה, הפחת מינון",
        urgency: "routine",
        category: "meds",
      },
      {
        text: "INR 5-9 → Vitamin K 1-2.5mg PO",
        urgency: "routine",
        category: "meds",
      },
      {
        text: "INR >9 / דימום → Vitamin K 5-10mg IV + FFP/PCC",
        urgency: "stat",
        category: "meds",
      },
    ],
  ...
  {
    trigger:
      /rivaroxaban|xarelto|ריבארוקסבן|apixaban|eliquis|אפיקסבן|dabigatran|pradaxa|דביגטרן|DOAC/i,
    ...
    tasks: [
      ...
      {
        text: "מעבדה: CBC, CMP, PT/INR, aPTT, Fibrinogen",
        urgency: "stat",
        category: "labs",
      },
      {
        text: "דימום על Xa-inhibitor (Xarelto/Eliquis) → Andexanet alfa (אם זמין) | PCC 25-50u/kg",
        urgency: "stat",
        category: "meds",
      },
      {
        text: "דימום על Dabigatran → Idarucizumab (Praxbind) 5g IV",
        urgency: "stat",
        category: "meds",
      },
      {
        text: "דימום GI → קונסולטציית גסטרו + NPO",
        urgency: "urgent",
        category: "consult",
      },
      {
        text: "ICH / דימום תוך-גולגלתי → נוירוכירורגיה STAT + CT ראש",
        urgency: "stat",
        category: "consult",
      },
      {
        text: "הערך תפקוד כלייתי — eGFR משפיע על קינטיקת DOAC",
        urgency: "urgent",
        category: "labs",
      },
    ],
  ...
  {
    trigger:
      /hemoptysis|המופטיסיס|כיח דמי|דם.*כיח|כיח.*דם|דם מהריאות|blood.*sputum|coughing.*blood/i,
    source: "המופטיסיס",
    group: "hemoptysis",
    triggerField: "all",
    tasks: [
      ...
      {
        text: "CBC, PT/INR, aPTT — הערך מצב קרישה",
        urgency: "stat",
        category: "labs",
      },
      {
        text: "CTPA — שלול PE וגורם וסקולרי / גידול",
        urgency: "urgent",
        category: "imaging",
      },
      {
        text: "אם על נוגד קרישה → הערך הפסקה vs המשך לפי מחלת רקע",
        urgency: "urgent",
        category: "meds",
      },
      {
        text: "המופטיסיס מסיבי (>200mL/24h) → ברונכוסקופיה + ICU",
        urgency: "stat",
        category: "consult",
      },
      {
        text: "ספוטום לתרבית + AFB אם חשד ל-TB",
        urgency: "routine",
        category: "labs",
      },
    ],
  ...
  // ═══ COPD EXACERBATION ═══
  {
    ...
    tasks: [
      {
        text: "Ventolin + Atrovent Nebulizer",
        urgency: "stat",
        category: "meds",
      },
      { text: "Prednisone 40mg PO x5d", urgency: "routine", category: "meds" },
      {
        text: "ABx אם כיח מוגלתי — DAG: Amox-Clav / Azithromycin",
        urgency: "routine",
        category: "meds",
      },
      ...
      { text: "CXR", urgency: "routine", category: "imaging" },
      {
        text: "אם pH<7.35 + pCO2>45 → BiPAP/NIV",
        urgency: "stat",
        category: "procedure",
      },
    ],
  ...
  // ═══ HYPOGLYCEMIA ═══
  {
    ...
    tasks: [
      {
        text: "🔴 בהכרה: 15-20g גלוקוז PO → בדיקה ב-15 דק'",
        urgency: "stat",
        category: "meds",
      },
      {
        text: "🔴 לא בהכרה: D50W 50ml IV / Glucagon 1mg IM",
        urgency: "stat",
        category: "meds",
      },
      {
        text: "מדידות סוכר q1h עד יציב >100",
        urgency: "stat",
        category: "labs",
      },
    ],
  ...
  // ═══ HYPONATREMIA ═══
  {
    ...
    tasks: [
      {
        text: "מעבדה: Na+, Serum Osm, Urine Na+Osm, TSH, Cortisol",
        urgency: "stat",
        category: "labs",
      },
      { text: "הערכת מצב נפחי", urgency: "routine", category: "other" },
      {
        text: "SIADH → הגבלת נוזלים 1-1.5L/d",
        urgency: "routine",
        category: "other",
      },
      {
        text: "Na<120 + סימפטומטי → NaCl 3% IV (מקס 8mEq/L/24h!)",
        urgency: "stat",
        category: "meds",
      },
  ...
  // ═══ STROKE / TIA ═══
  {
    ...
    tasks: [
      {
        text: "🔴 CT ראש דחוף (שלילת דימום)",
        urgency: "stat",
        category: "imaging",
      },
      {
        text: "🔴 זמן תחילת סימפטומים (חלון tPA: 4.5h)",
        urgency: "stat",
        category: "other",
      },
      { text: "NIHSS score", urgency: "stat", category: "other" },
      {
        text: "מעבדה: CBC, CMP, PT/INR, Glucose, Troponin",
        urgency: "stat",
        category: "labs",
      },
      { text: "ECG (חיפוש AF)", urgency: "stat", category: "labs" },
      {
        text: "התייעצות נוירולוגיה דחופה",
        urgency: "stat",
        category: "consult",
      },
  ...
  {
    trigger:
      /hypertensive\s*(urgency|emergency|crisis)|לחץ דם גבוה|BP\s*>\s*18\d|SBP\s*>\s*18\d|יתר לחץ דם חד/i,
    source: "משבר יתר לחץ דם",
    group: "htnemergency",
    triggerField: "tasks",
    tasks: [
      {
        text: "בדוק סימני end-organ damage: כאב ראש, הפרעות ראיה, כאב חזה, קוצר נשימה",
        urgency: "routine",
        category: "other",
      },
      {
        text: "אם ללא end-organ → PO: captopril 25mg / amlodipine 5mg",
        urgency: "routine",
        category: "meds",
      },
      {
        text: "אם end-organ → IV labetalol 20mg / nicardipine gtt → שקול ICU",
        urgency: "stat",
        category: "meds",
      },
      {
        text: "BP חוזר כל 15-30 דקות — יעד ירידה 10-20% בשעה הראשונה",
        urgency: "stat",
        category: "other",
      },
    ],
  ...
  // ═══ SYNCOPE ═══
  {
    ...
    tasks: [
      {
        text: "ECG 12 leads — בדוק QT, Brugada, AV block, arrhythmia",
        urgency: "stat",
        category: "labs",
      },
      {
        text: "BP שכיבה + עמידה (orthostatic)",
        urgency: "routine",
        category: "other",
      },
      {
        text: "CBC, glucose, troponin, BMP",
        urgency: "stat",
        category: "labs",
      },
      {
        text: "אם cardiac syncope → telemetry + קרדיולוג",
        urgency: "stat",
        category: "consult",
      },
    ],
  ...
  {
    trigger:
      /דסטורציה|desaturation|SpO2\s*<\s*9[0-3]|היפוקסיה|hypoxia|חמצן נמוך/i,
    source: "דסטורציה",
    group: "desat",
    triggerField: "tasks",
    tasks: [
      {
        text: "🔴 O2 — NC / mask / NRB — יעד SpO2 >92% (COPD: 88-92%)",
        urgency: "stat",
        category: "meds",
      },
      { text: "ABG / VBG", urgency: "stat", category: "labs" },
      {
        text: "CXR — בדוק pneumothorax, effusion, edema, pneumonia",
        urgency: "stat",
        category: "imaging",
      },
      {
        text: "אם לא מגיב → שקול BiPAP / intubation → ICU",
        urgency: "stat",
        category: "consult",
      },
    ],
  ...
  {
    trigger:
      /כאב בטן חד|acute abdomen|בטן חריפה|ileus|אילאוס|חסימת מעי|bowel obstruct/i,
    source: "בטן חריפה",
    group: "abdomen",
    triggerField: "tasks",
    tasks: [
      {
        text: "בדיקה גופנית: סימני פריטונאליים, אוושות מעי, נפיחות",
        urgency: "routine",
        category: "other",
      },
      {
        text: "מעבדה: CBC, CRP, lactate, lipase, LFTs",
        urgency: "stat",
        category: "labs",
      },
      {
        text: "צילום בטן עמידה / CT בטן אם חשד ניתוחי",
        urgency: "stat",
        category: "imaging",
      },
      {
        text: "NPO + IV fluids + שקול ייעוץ כירורגי",
        urgency: "stat",
        category: "consult",
      },
    ],
  ...
  {
    trigger:
      /גמילה מאלכוהול|alcohol withdrawal|CIWA|DT\b|delirium tremens|גמילה מבנזו/i,
    source: "גמילה",
    group: "withdrawal",
    triggerField: "tasks",
    tasks: [
      {
        text: "CIWA score q1-2h — אם >8 → טפל",
        urgency: "routine",
        category: "other",
      },
      {
        text: "Diazepam 5-10mg PO/IV PRN (or lorazepam 1-2mg אם כבד)",
        urgency: "stat",
        category: "meds",
      },
      {
        text: "Thiamine 100mg IV לפני גלוקוז!",
        urgency: "stat",
        category: "meds",
      },
      {
        text: "אם seizure / DTs → ICU + benzo gtt",
        urgency: "stat",
        category: "consult",
      },
    ],
  ...
  // ═══ ANAPHYLAXIS ═══
  {
    ...
    tasks: [
      {
        text: "🔴 Epinephrine 0.3mg IM (ירך חיצונית) — חזור כל 5-15 דקות",
        urgency: "stat",
        category: "meds",
      },
      { text: "NS 1L bolus IV", urgency: "stat", category: "meds" },
      {
        text: "Diphenhydramine 50mg IV + Ranitidine 50mg IV + Methylprednisolone 125mg IV",
        urgency: "stat",
        category: "meds",
      },
      {
        text: "ניטור 6-24 שעות (biphasic reaction)",
        urgency: "routine",
        category: "other",
      },
    ],
  ...
  // ═══ ACUTE URINARY RETENTION ═══
  {
    ...
    tasks: [
      {
        text: "Bladder Scan — אם >300ml → הכנס קטטר",
        urgency: "stat",
        category: "procedure",
      },
      {
        text: "אם >1L → שחרור איטי (500ml כל 30 דק) — סכנת post-obstructive diuresis",
        urgency: "routine",
        category: "other",
      },
      {
        text: "בדוק סיבה: anticholinergics, opioids, BPH, constipation",
        urgency: "routine",
        category: "other",
      },
    ],
  ...
  // ═══ ACUTE ANEMIA / DROPPING HB ═══
  {
    ...
    tasks: [
      ...
      {
        text: "בדוק מקור דימום: GI, wound, retroperitoneal, fracture",
        urgency: "stat",
        category: "other",
      },
      {
        text: "CBC, retic, LDH, haptoglobin, coags",
        urgency: "stat",
        category: "labs",
      },
      {
        text: "אם Hb<7 סימפטומטי → עירוי PRBC (Hb<8 אם cardiac)",
        urgency: "stat",
        category: "meds",
      },
    ],
  ...
  {
    trigger:
      /אינסולין\s*(?:מתמשך|ווריד|IV|drip|infusion)|insulin\s*(?:drip|infusion|gtt|iv)|actrapid\s*(?:drip|infusion|iv)/i,
    source: "אינסולין IV",
    group: "iv_insulin",
    triggerField: "all",
    tasks: [
      {
        text: "BS q2h (q1h after rate change)",
        urgency: "routine",
        category: "procedure",
      },
      {
        text: "אם BS<70 → STOP drip, D50% 50ml IV, recheck q15min",
        urgency: "stat",
        category: "meds",
      },
      {
        text: "Target BS 140-180; titrate per protocol",
        urgency: "routine",
        category: "meds",
      },
    ],
  ...
  {
    trigger:
      /הפרין\s*(?:מתמשך|ווריד|IV|drip|infusion|gtt)|heparin\s*(?:drip|infusion|gtt|iv|protocol)|UFH\b/i,
    source: "הפרין IV",
    group: "iv_heparin",
    triggerField: "all",
    tasks: [
      {
        text: "PTT q6h — titrate per nomogram",
        urgency: "routine",
        category: "labs",
      },
      {
        text: "CBC + platelets daily (HIT watch)",
        urgency: "routine",
        category: "labs",
      },
      {
        text: "בדוק סימני דימום: guaiac, hemoglobin, sites",
        urgency: "routine",
        category: "other",
      },
    ],
  ...
  {
    trigger:
      /נוראדרנלין|noradrenaline|norepinephrine|levophed|vasopressor|ואזופרסור/i,
    source: "נוראדרנלין / vasopressor",
    group: "iv_vasopressor",
    triggerField: "all",
    tasks: [
      {
        text: "BP q15-30min, target MAP ≥65",
        urgency: "routine",
        category: "procedure",
      },
      {
        text: "Lactate q4-6h — trend for perfusion",
        urgency: "routine",
        category: "labs",
      },
      {
        text: "Urine output q1h — target ≥0.5 ml/kg/h",
        urgency: "routine",
        category: "procedure",
      },
      {
        text: "Verify central line access + functioning",
        urgency: "routine",
        category: "other",
      },
    ],
  ...
  // ── Dopamine ──
  {
    ...
    tasks: [
      {
        text: "BP + HR q15-30min; titrate to target",
        urgency: "routine",
        category: "procedure",
      },
      {
        text: "Monitor for tachyarrhythmia",
        urgency: "routine",
        category: "other",
      },
  ...
  // ── Amiodarone (Procor) IV ──
  {
    ...
    tasks: [
      {
        text: "Continuous telemetry — watch QTc + HR",
        urgency: "routine",
        category: "procedure",
      },
      {
        text: "BP q30min during loading (hypotension risk)",
        urgency: "routine",
        category: "procedure",
      },
      {
        text: "Check K+, Mg2+ — correct before/during infusion",
        urgency: "routine",
        category: "labs",
      },
    ],
  ...
  // ── Propofol ──
  {
    ...
    tasks: [
      {
        text: "הערכת רמת סדציה q2h — תעד תגובתיות",
        urgency: "routine",
        category: "procedure",
      },
      {
        text: "TG level q48h if >48h infusion (propofol infusion syndrome)",
        urgency: "routine",
        category: "labs",
      },
  ...
  {
    trigger:
      /מורפין\s*(?:מתמשך|ווריד|IV|drip|infusion)|morphine\s*(?:drip|infusion|gtt|iv|PCA)|פנטניל\s*(?:מתמשך|ווריד|IV|drip)|fentanyl\s*(?:drip|infusion|gtt|iv|PCA)/i,
    source: "אופיואידים IV",
    group: "iv_opioid",
    triggerField: "all",
    tasks: [
      {
        text: "RR + SpO2 q2h — hold if RR<10 or SpO2<90%",
        urgency: "routine",
        category: "procedure",
      },
      {
        text: "Naloxone 0.4mg IV bedside (emergency reversal)",
        urgency: "routine",
        category: "meds",
      },
      {
        text: "Bowel protocol — עצירות צפויה",
        urgency: "routine",
        category: "meds",
      },
    ],
  ...
  // ── Midazolam (Dormicum) drip ──
  {
    ...
    tasks: [
      {
        text: "RR + SpO2 q2h — סיכון לדיכוי נשימתי",
        urgency: "routine",
        category: "procedure",
      },
      {
        text: "הערכת רמת הכרה q2h — תעד תגובתיות",
        urgency: "routine",
        category: "procedure",
      },
      {
        text: "⚠️ Flumazenil 0.2mg IV מוכן ליד המיטה (reversal חירום — שימוש רק אם דיכוי נשימתי)",
        urgency: "routine",
        category: "meds",
      },
    ],
  ...
  {
    trigger:
      /מגנזיום\s*(?:IV|ווריד|infusion|drip)|magnesium\s*(?:iv|infusion|drip|sulfate\s*iv)/i,
    source: "מגנזיום IV",
    group: "iv_magnesium",
    triggerField: "all",
    tasks: [
      {
        text: "Mg2+ level post-infusion (recheck 2h after)",
        urgency: "routine",
        category: "labs",
      },
      {
        text: "Monitor DTRs during infusion (loss = toxicity)",
        urgency: "routine",
        category: "procedure",
      },
      {
        text: "BP + HR during infusion (hypotension/bradycardia)",
        urgency: "routine",
        category: "procedure",
      },
    ],
  ...
  {
    trigger:
      /אשלגן\s*פוספט|potassium\s*phosphate\s*(?:iv|infusion)|KPhos\b|K.?phosphate/i,
    source: "K-Phosphate IV",
    group: "iv_kphos",
    triggerField: "all",
    tasks: [
      {
        text: "Phosphate + Ca2+ + K+ recheck 2h post-infusion",
        urgency: "routine",
        category: "labs",
      },
      {
        text: "Infuse over ≥4h via central line if available",
        urgency: "routine",
        category: "meds",
      },
    ],
  ...
  // ── Comfort sedation — qualitative symptom check (palliative only) ────────────
  ...
  {
    trigger:
      /מורפין|morphine|fentanyl|פנטניל|midazolam|dormicum|דורמיקום|מידזולם/i,
    ...
    tasks: [
      {
        text: "הערכת נוחות: נשימה נוחה? גרגור/הפרשות? סימני כאב? אי-שקט? (ללא מדידת RR/SpO2)",
        urgency: "routine",
        category: "procedure",
      },
      {
        text: "גרגור? → Hyoscine (Buscopan) 0.4mg SC/SL PRN להפחתת הפרשות",
        urgency: "routine",
        category: "meds",
      },
    ],
...
export function applyRules(patient: PatientEntry): Task[] {
  ...
  for (const rule of RULES) {
    ...
    if (
      isComfortCareOnly &&
      rule.group &&
      COMFORT_SUPPRESSED_GROUPS.has(rule.group)
    ) {
    ...
    if (rule.trigger.test(textToMatch)) {
      ...
      if (rule.skipIfExplicitTaskMatches) {
        const explicitTaskText = (patient.tasks ?? [])
          .map((t) => t.text)
          .join(" ");
